...
@section('title','Menambahkan Admin')

@section('nama_halaman','Menambahkan Admin')
...
<div class="card card-primary card-outline">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-edit"></i> Form Tambah User</h3>
      </div>
      <div class="card-body">
          <form class="form" action="{{route('admins.store')}}" method="POST">
            ...
            <div class="form-group">
              <button class="btn btn-success" type="submit">Tambahkan Admin</button>
            </div>
          </form>
      </div>
    </div>
